...
import { ChevronDown, ChevronUp, ExternalLink, AlertCircle, AlertTriangle, Info } from 'lucide-react';
...
export default function IncidentsPanel({ refreshInterval = 30000 }: IncidentsPanelProps) {
