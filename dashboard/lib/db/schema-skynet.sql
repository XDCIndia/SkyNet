-- XDC SkyNet Database Schema
-- Use a separate schema to not conflict with other applications
...
-- Migration tracking
CREATE TABLE IF NOT EXISTS skynet.migrations (
  id SERIAL PRIMARY KEY,
...
INSERT INTO skynet.migrations (name) VALUES ('001_initial_schema')
